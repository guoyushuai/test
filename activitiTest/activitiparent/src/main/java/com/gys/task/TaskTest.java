...
public class TaskTest {
    ...
    public void deployment() {
        ...
        Deployment deploy = engine.getRepositoryService()
                ...
                .name("task")//添加部署名称
                .addClasspathResource("diagrams/task.bpmn")//从classpath中加载资源文件，每次一个
                .addClasspathResource("diagrams/task.png")
                .deploy();//完成部署
    ...
    public void startProcess() {
        ...
        ProcessInstance instance = engine.getRuntimeService()
                .startProcessInstanceByKey("task");//,maps使用流程定义的key启动流程实例property:id的value:myProcessTest

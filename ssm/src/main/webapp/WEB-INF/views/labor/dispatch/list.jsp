        ...
        <section class="content">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">雇佣合同列表</h3>

                    <div class="box-tools pull-right">
                        <a href="/labor/dispatch/new" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="box-body">
                    <table class="table">
    ...
    $(function () {
            ...
            "columns":[
                ...
                {"data":function (row) {//row当前行的对象
                    if(row.serialNumber) {//有数据显示，没数据显示NUll,
                        return "<a href='/labor/dispatch/" + row.serialNumber + "'>" + row.serialNumber + "</a>";//需要客户端返回流水号以便于点击后能展示相应合同雇佣的详情
                    } else {
        ...
        $(document).delegate(".checkBtn","click",function(){
            ...
            layer.confirm("确定合同已完成么？",{btn:['确定','取消']},function(index){
                ...
                $.post("/labor/dispatch/state/change",{"id":id}).done(function (result) {
